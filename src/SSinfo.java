...
public class SSinfo extends javax.swing.JFrame {
    ...
    List<SSobject> sofas = new ArrayList<>(); // implemented list.
 ...
 */
    ...
    try {
        ...
        int index = ObjBinSearch.binarySearch(sofas, new SSobject(null,null,null,null,priceSearch), new PriceSorter());
        ...
        try {
            ...
            else if(price <= 0) 
            {
                ...
                if(!duplicates || sofas.size() <= 0){
                        sofas.add(new SSobject(sofaId, sofaName, category, colour, price));
                        insertOnTable();
                    }
            }
        } catch (NumberFormatException e) {
